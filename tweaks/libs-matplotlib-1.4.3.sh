...
deps=(apps-python-2.7.8 apps-python3-3.3.3 apps-python3-3.4.3 libs-numpy-1.9.2 libs-numpy_python3-1.9.2 libs-numpy-python34-1.9.2 apps-setuptools-2.1 apps-setuptools_python3-2.1 apps-setuptools_python34-2.1)
for dep in "${deps[@]}"; do
